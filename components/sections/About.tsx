...
export function About() {
  return (
    <section id="about" className="bg-white min-h-screen flex flex-col justify-center py-[var(--section-py)]">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[var(--text-heading)] mb-10 leading-tight">
              О нашей мечети
            </h2>
          ...
          <div className="relative shrink-0">
            <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[420px] lg:h-[480px] rounded-[var(--radius-card)] overflow-hidden shadow-[var(--shadow-card)]">
              <Image
                src={ABOUT_IMAGE}
                alt="Минарет мечети Рамазан с бирюзовыми куполами и хвойное дерево на фоне голубого неба"
                fill
